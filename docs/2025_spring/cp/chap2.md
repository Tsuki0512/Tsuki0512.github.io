...
![image-20250220144859138](./chap2.assets/image-20250220144859138.png)
...
![image-20250220144938887](./chap2.assets/image-20250220144938887.png)
...
![image-20250220145225716](./chap2.assets/image-20250220145225716.png)
...
![image-20250220145928685](./chap2.assets/image-20250220145928685.png)

例子：

![image-20250220145957907](./chap2.assets/image-20250220145957907.png)

### 2.2.2 正则表达式在词法分析中的应用

流程：

![image-20250220150111551](./chap2.assets/image-20250220150111551.png)
...
![image-20250220151207470](./chap2.assets/image-20250220151207470.png)

NFA转换函数的解释：

![image-20250220151400945](./chap2.assets/image-20250220151400945.png)

整体流程：

![image-20250220151900858](./chap2.assets/image-20250220151900858.png)
...
![image-20250220152124914](./chap2.assets/image-20250220152124914.png)
...
- **蔓延性条件**：其次，如果for any symbol c, `trans[s1, c] == trans[s2, c]`，那么`s1`和`s2`等价。

另外一种定义的写法：

![image-20250227133726324](./chap2.assets/image-20250227133726324.png)
...
- **划分部分**：根据以上条件迭代式划分等价类
  ...
  ![image-20250227134411497](./chap2.assets/image-20250227134411497.png)

- **构造部分**：从划分得到的等价类中选取代表，并重建DFA

例子：

![image-20250227134548061](./chap2.assets/image-20250227134548061.png)
