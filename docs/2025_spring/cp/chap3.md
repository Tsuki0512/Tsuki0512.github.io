...
我们需要解决的关键问题是如何知道栈顶内容可以规约，这个时候我们就要维护一个状态，记录当前识别的进度：
...
#### 3.3.2.2 LR(0) Parsing DFA和分析表

那我们可不可以跳过NFA直接构造DFA呢？

- 这就相当于我们直接去构造项集闭包 - 递归地加入闭包内产生式右边第一个非终结符的产生式
...
![image-20250306154424161](./chap3.assets/image-20250306154424161.png)

![image-20250306154434259](./chap3.assets/image-20250306154434259.png)

#### 3.3.2.3 LR(0) Parsing过程
